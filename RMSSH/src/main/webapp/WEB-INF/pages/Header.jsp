<%@page import="in.co.mss.rmssh.dto.RoleDTO"%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@taglib uri="http://www.springframework.org/tags/form" prefix="sf"%>
<%@taglib uri="http://www.springframework.org/tags" prefix="s"%>

<%@page import="in.co.mss.rmssh.dto.UserDTO"%>
...
<nav class="navbar navbar-inverse">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" style="margin-top: -10;"><img alt="Brand"
				src="http://localhost:8080/ORS_Project0/resources/images/logo.png"
				width="140"></a>
		</div>
		...
		<div class="collapse navbar-collapse"
					...
					<c:if test="${sessionScope.user.roleId == 1}">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider" style="background-color: Grey;"></li>
								<li><a href="<c:url value="/rest/Role/search" />"><span
										class="glyphicon glyphicon-th-list"></span>&emsp;<s:message
											code="label.listRoleRest" /> </a></li>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown"><a href="/" class="dropdown-toggle"
					data-toggle="dropdown" role="button" aria-haspopup="true"
					aria-expanded="false"><span class="glyphicon glyphicon-user"></span>&nbsp;<s:message
							code="label.Welcome" /> <c:out
							value="${sessionScope.user.firstName}" /> <%-- <c:out
							value="${sessionScope.user.lastName}" /> --%> ( <%-- <c:when
								test="${sessionScope.role}">HOw</c:when> --%> <%-- <c:if
								test="${!empty sessionScope.role}">How</c:if> --%> <c:choose>
						...
						<c:if test="${not empty sessionScope.user}">
							...
							<c:if test="${sessionScope.user.roleId == 1}">
								<li class=""><a target="blank"
									href="<c:url value="http://localhost:8080/ORS_Project0/resources/doc/index.html"  />"><span
